...
**Type the code (from the grey boxes below) into the SCRIPT window of RStudio. Run each line using the [Run button](RStudioRun.png) (top left of the SCRIPT window in RStudio)**
  
### Make the tools you need available in R.

Packages are like books from the library; packages are pre-written bundles of code that can perform the tasks we want. 
  
```{r }
library(gsheet)
```

### Tell R where to get your data.
...
### Add a boxplot on top of your plot

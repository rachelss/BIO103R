...
* load the library that allows us to the plotting commands (copy, paste and run lines in grey boxes. Include "# comments".)  (***Remember:  Packages are like books from the library; packages are pre-written bundles of code that can perform the tasks we want.***) Make a package accessible to your R script by typing library(packageName).

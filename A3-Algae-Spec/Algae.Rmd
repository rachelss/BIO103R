...
Today you will make a graph that illustrates the absorption rates of your algae samples at different wavelengths. When you are done you will be able to compare your three algae species spectromoter outputs at once. 
...
### 1a. Put data in long form on Google Sheets and share it with your team

Put your group's data into a Google Sheet in _*long form*_. Set it up with the column names `Algae` (algae_names or A,B,C), `Wavelength` (400 to 700, by tens), and `Absorption` (what you measured). You should have 1 header row and 93 rows of data total.
...
```{r head, eval=FALSE}
# Check your data to make sure it looks right 
# (first lines only and column names)
...
Just like last time, you are going to use `ggplot` to graph your algae data. We want to compare which wavelengths are more absorbed or less absorbed by different species of algae. We are going to graph the data as points. 
...
1. Summary table for your group's data (*wide form*, made in excel/sheets/or R).

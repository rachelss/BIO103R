...
* Load the data into R and view it. Make sure time is a variable not a label - it is the dependent variable.
...
* Save your model to a variable. Note the slope and the intercept. The slope is the respiration rate (ppm / min).
